...
public class BookUI {
...

    {
        ...
        switch (option) {
            case 1: {
                ...
                if (books.isEmpty()){
                    System.out.println("Không có quyen sách nào trong danh sách");
                } else {
            ...
            case 2: {
                ...
                if (books.isEmpty()){
                    System.out.println("Không có quyen sách nào tên là " + name);
                } else {
                    System.out.println("Danh sách books có tên " + name + " là:");
                    for (Book b : books
                    ) {
                        System.out.println(b);
                    }
            ...
            case 4: {
                System.out.println("Nhập ID can chỉnh sửa: ");
                int id = Integer.parseInt(sc.nextLine());
    ...
    public static void showMenu() {
        ...
        System.out.println("4 - Thay đổi thông tin");
        System.out.println("5 - Thêm 1 cuốn sách");
